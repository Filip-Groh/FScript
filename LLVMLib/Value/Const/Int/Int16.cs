...
namespace LLVMLibrary.Value.Const {
    ...
    public static unsafe partial class ConstantLibrary {
        public static ConstInt16Pointer CreateConstInt16(TypeInt16Pointer intType, ulong number, bool isSigned) {
            return new ConstInt16Pointer(LLVM.ConstInt(intType.pointer, number, isSigned ? 1 : 0));
        }
    }
}